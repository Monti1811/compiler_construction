...
void IfStatement::compile(std::shared_ptr<CompileScope> CompileScopePtr)
{
    ...
    if (value_condition->getType()->isIntegerTy(32)) {
        ...
        value_condition = CompileScopePtr->_Builder.CreatePtrToInt(value_condition, CompileScopePtr->_Builder.getInt32Ty());
        value_condition = CompileScopePtr->_Builder.CreateICmpNE(CompileScopePtr->_Builder.getInt32(0), value_condition);
    }
...
void WhileStatement::compile(std::shared_ptr<CompileScope> CompileScopePtr)
{
    ...
    if (while_condition->getType()->isIntegerTy(32)) {
        ...
        // return 0 if nullptr, 1 otherwise
        while_condition = CompileScopePtr->_Builder.CreatePtrToInt(while_condition, CompileScopePtr->_Builder.getInt32Ty());
        while_condition = CompileScopePtr->_Builder.CreateICmpNE(CompileScopePtr->_Builder.getInt32(0), while_condition);
    }
